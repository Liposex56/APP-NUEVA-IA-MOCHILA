(() => {
  ...
  const tools = [
    ...
    ["imagen", "https://stability.ai", "", "Stable Diffusion", "Generación de imágenes para ilustraciones y apoyos visuales.", "SD", "Imagen", "c-img", "#4a3368,#7552aa"],
    ["imagen", "https://openai.com/dall-e", "", "DALL·E", "Generador visual para recursos creativos y ejemplos didácticos.", "DAL", "Imagen", "c-img", "#2c7869,#4bb09b"],
    ...
    ["diseno", "https://www.adobe.com/express", "", "Adobe Express", "Creación de piezas visuales, publicaciones y clips breves.", "AE", "Diseño", "c-tools", "#9b4f2b,#d98d56"],
    ["audio", "https://www.descript.com", "", "Descript", "Edición de audio y video mediante transcripción.", "DS", "Audio", "c-audio", "#874a69,#ca81a4"],
    ...
    ["video", "https://pictory.ai", "", "Pictory", "Transforma artículos o guiones en videos cortos.", "PT", "Video", "c-video", "#33724d,#4ea675"],
    ["escritura", "https://www.grammarly.com", "", "Grammarly", "Corrección de gramática, claridad, tono y reescritura.", "GM", "Escritura", "c-edu", "#236b62,#3db3a1"],
    ...
    ["docencia", "https://kahoot.com", "", "Kahoot!", "Gamificación para repasos, participación y dinámicas de aula.", "KH", "Docencia", "c-edu", "#5c4994,#8e76d4"],
    ["docencia", "https://socratic.org", "", "Socratic", "Apoyo al estudiante para resolver dudas paso a paso.", "SC", "Docencia", "c-edu", "#2f6f87,#4da8c1"],
    ["diseno", "https://www.slidesai.io", "", "SlidesAI", "Genera presentaciones desde texto con estructura inicial.", "SA", "Diseño", "c-tools", "#2a5382,#6193d0"],
    ...
    ["docencia", "https://www.magicschool.ai", "", "Magic School AI", "Herramientas de IA pensadas para planeación, rúbricas y apoyo docente.", "MS", "Docencia", "c-edu", "#74477b,#b46dc3"],
  ];
